      ...
      <div class="col-md my-4 p-0 text-center">
        ...
        >
          ...
          <div class="mb-3 px-4">
            ...
            <Message
              v-if="$form.emailTelefone?.invalid"
              class="mt-1 text-start"
              severity="error"
              size="small"
              variant="simple"
          ...
          <div class="mb-3 px-4">
            <div class="form-text text-muted">
              ...
              <router-link to="/informacoes-legais/termos-de-uso">Termos de Uso</router-link> e a
              <router-link to="/informacoes-legais/politica-de-privacidade"
                >Politica de Privacidade</router-link
              >
            </div>
          </div>
